package com.geek.lock.local.annotation;
 ...
 * Local Lock 注解
 * 
 * <p>使用本地锁作为 LockProvider 的快捷注解。</p>
 */
...
public @interface LocalLock {
    ...
    Class<? extends com.geek.lock.core.LockProvider> provider() default LocalLockProvider.class;
}