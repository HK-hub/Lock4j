...
import com.geek.lock.local.annotation.LocalLock;
...
public class OrderController {
    ...
    @LocalLock(keys = "#userId", waitTime = 5000, leaseTime = 30000)
    ...
    @LocalLock(keys = {"#productId", "#warehouseId"}, waitTime = 3000, leaseTime = 30000)
