...
import com.geek.lock.etcd.annotation.EtcdLock;
...
public class OrderController {
    ...
    @EtcdLock(keys = "#userId", waitTime = 5000, leaseTime = 30000)
    ...
    @EtcdLock(keys = {"#productId", "#warehouseId"}, waitTime = 3000, leaseTime = 30000)
