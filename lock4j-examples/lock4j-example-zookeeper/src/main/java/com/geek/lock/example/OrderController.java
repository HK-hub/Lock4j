...
import com.geek.lock.zookeeper.annotation.ZookeeperLock;
...
public class OrderController {
    ...
    @ZookeeperLock(keys = "#userId", waitTime = 5000, leaseTime = 30000)
    ...
    @ZookeeperLock(keys = {"#productId", "#warehouseId"}, waitTime = 3000, leaseTime = 30000)
