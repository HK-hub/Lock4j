package com.geek.lock.redisson.annotation;
 ...
 * Redisson Lock 注解
 * 
 * <p>使用 Redisson 作为 LockProvider 的快捷注解。</p>
 */
...
public @interface RedissonLock {
    ...
    Class<? extends com.geek.lock.core.LockProvider> provider() default RedissonLockProvider.class;
}